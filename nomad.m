...
%% Updates
%---------------
% NOMAD - Version 3.0 - May, 2013

%Now creates gdf files that BOXY can load automatically as graphs
%Many other little bug fixes as people start to use the software

%TODO
% - If the restart button could save the first montage and only restart the second that would be great =)
% - Save button on color screen
% - Waiting or progress bar during colouring
...
%TODO 
% - Save some settings and load them?
% DONE - Change colouring during montage selection
% DONE - Fix undo for source placement, the other source of cross talk problems right now
% - Create buttons to return to detector, right click detector during srcs?
% - Space out detectors in bounding box
% - Space out srcs in bounding box
% - Add funcitonality for patches
% DONE - Update GDF creator with .dll from DENIS for correct BOXY file creation
% - Display lines on surface of convex hull and shade the hull as such
% - Better 2D projection of ELP file for schematic
% - Create output for DENIS and BOXY to visualize signal quality
% DONE - Change shading of src holes 
% DONE - Made schematic background grey - JW 
